...
// ─────────────────────────────────────────────────────────────────────────────
// DATOS DE CARACTERÍSTICAS (extraídos para reducir complejidad)
// ─────────────────────────────────────────────────────────────────────────────
...
const FEATURES = [
  { 
    icon: 'bag-handle', 
    title: 'Tienda Online', 
    desc: 'Compra productos de belleza naturales y de calidad', 
    color: '#553e30', 
    bg: '#efe0d1' 
  },
  { 
    ...
    desc: 'Especialistas en cuidado personal y belleza', 
    color: '#553e30', 
    bg: '#efe0d1' 
  },
  { 
    icon: 'calendar-clear', 
    title: 'Agenda Citas Fácil', 
    desc: 'Reserva tus servicios de forma rápida y segura', 
    color: '#553e30', 
    bg: '#efe0d1' 
  },
  { 
    icon: 'leaf', 
    title: '100% Natural', 
    desc: 'Productos y servicios con ingredientes naturales', 
    color: '#553e30', 
    bg: '#efe0d1' 
  },
] as const;
...
export default function HomeScreen() {
  ...
  // ✅ SOLUCIÓN: Eliminadas variables no usadas
  // Si necesitas estos estados en el futuro, descoméntalos
  // const [productos, setProductos] = useState<any[]>([]);
  // const [servicios, setServicios] = useState<any[]>([]);
  // const [refreshing, setRefreshing] = useState(false);

  // ✅ SOLUCIÓN: Si necesitas el estado de refreshing para el RefreshControl
  const [refreshing, setRefreshing] = useState(false);

  // ─────────────────────────────────────────────────────────────────────────────
  // FUNCIONES DE MANEJO DE REFRESH
  // ─────────────────────────────────────────────────────────────────────────────

  const handleRefresh = () => {
    setRefreshing(true);
    // Simular carga o recargar datos
    setTimeout(() => {
      setRefreshing(false);
    }, 1000);
  };
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  // FUNCIONES DE NAVEGACIÓN (extraídas para código más limpio)
  // ─────────────────────────────────────────────────────────────────────────────

  const navigateToProductos = () => {
    router.push('/screens/productos');
  };

  const navigateToServicios = () => {
    router.push('/screens/servicios');
  };
