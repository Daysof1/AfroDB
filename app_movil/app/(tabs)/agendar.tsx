...
// ✅ COMPONENTE DE SERVICIO (fuera del componente principal)
// ─────────────────────────────────────────────────────────────
...
const ServicioItem = ({ item, selected, isPreseleccionado, onToggle }: ServicioItemProps) => {
    return (
        <Pressable 
...
export default function AgendarScreen() {
    ...
    const handleSubmit = async () => {
        ...
        const payload = { fecha, hora: horaFormateada, servicios: selectedIds };
        ...
        <ScrollView style={styles.container} contentContainerStyle={styles.content}>
                        ...
                        {servicios
                            ...
                            .map((servicio) => (
                                <View key={servicio.id}>
                                    <ServicioItem
                                        item={servicio}
                                        selected={selectedIds.includes(String(servicio.id))}
                                        isPreseleccionado={servicioSeleccionado?.id === servicio.id}
            ...
            <View style={styles.formContainer}>
                ...
                <View style={styles.formSection}>
                    ...
                    {Platform.OS === 'web' ? (
                        <View style={[styles.input, styles.timeInputWeb, horaError ? styles.inputError : null]}>
