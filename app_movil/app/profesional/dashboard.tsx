...
const styles = StyleSheet.create({
  ...
  hero: { backgroundColor: '#c8a27a', borderRadius: 24, padding: 18, gap: 16 },
  ...
  statCard: { minWidth: 100, flex: 1, backgroundColor: '#fff', borderRadius: 16, paddingVertical: 16, paddingHorizontal: 12, alignItems: 'center', borderWidth: 1, borderColor: '#e6d3b3', shadowColor: '#000', shadowOpacity: 0.04, shadowRadius: 8, shadowOffset: { width: 0, height: 3 }, elevation: 2 },
  statValue: { color: '#c8a27a', fontSize: 22, fontWeight: '800' },
  ...
  input: { borderWidth: 1, borderColor: '#d6c7ae', borderRadius: 12, paddingHorizontal: 12, paddingVertical: 10, backgroundColor: '#fff' },
  ...
  primaryAction: { backgroundColor: '#c8a27a' },
  ...
  statusBtnActive: { backgroundColor: '#a56363' },
