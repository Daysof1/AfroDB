...
const estadoColor = (estado?: string) => {
  if (estado === 'confirmada') return '#a57c63';
  if (estado === 'completada') return '#6b8e6f';
...
const styles = StyleSheet.create({
  ...
  restricted: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 24, gap: 12, backgroundColor: '#f7fafc' },
  restrictedText: { textAlign: 'center', color: '#7b6758' },
  backButton: { backgroundColor: '#a57c63', borderRadius: 12, paddingHorizontal: 16, paddingVertical: 12 },
  backButtonText: { color: '#fff', fontWeight: '700' },
  hero: { backgroundColor: '#a57c63', borderRadius: 24, padding: 18, gap: 16 },
  heroTop: { flexDirection: 'row', alignItems: 'flex-start', gap: 12 },
  heroLabel: { color: '#f3e6d8', textTransform: 'uppercase', letterSpacing: 1, fontSize: 12, fontWeight: '700' },
  heroSubtitle: { color: '#f9f6f2', marginTop: 6 },
  heroIconWrap: { width: 52, height: 52, borderRadius: 18, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(255,255,255,0.16)' },
  statsRow: { flexDirection: 'row', gap: 10 },
  statCard: { flex: 1, backgroundColor: 'rgba(255,255,255,0.16)', borderRadius: 16, paddingVertical: 12, alignItems: 'center' },
  statValue: { color: '#fff', fontSize: 22, fontWeight: '800' },
  statLabel: { color: '#f3e6d8', fontSize: 12, marginTop: 2 },
  ...
  card: { backgroundColor: '#fff', borderRadius: 18, padding: 16, gap: 10, borderWidth: 1, borderColor: '#efe6dc' },
  input: { borderWidth: 1, borderColor: '#d8c5b2', borderRadius: 12, paddingHorizontal: 12, paddingVertical: 10, backgroundColor: '#fff' },
  ...
  primaryAction: { backgroundColor: '#a57c63' },
  inlinePrimary: { backgroundColor: '#a57c63', alignSelf: 'flex-start', marginTop: 4 },
  primaryActionText: { color: '#fff', fontWeight: '700' },
  secondaryAction: { backgroundColor: '#e9dfd4' },
  secondaryActionText: { color: '#5f4638', fontWeight: '700' },
  ...
  chipText: { color: '#8c6a4a', fontWeight: '700' },
  subsectionTitle: { marginTop: 4, color: '#3e2f25', fontWeight: '800' },
  availableGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  availableChip: { flexDirection: 'row', alignItems: 'center', gap: 6, borderWidth: 1, borderColor: '#a57c63', borderRadius: 999, paddingHorizontal: 12, paddingVertical: 8 },
  availableChipText: { color: '#a57c63', fontWeight: '700' },
  ...
  statusBtnIdle: { backgroundColor: '#e9dfd4' },
  statusBtnIdleText: { color: '#5f4638', fontWeight: '700', fontSize: 12 },
  statusBtnActive: { backgroundColor: '#a57c63' },
