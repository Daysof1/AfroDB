...
export default function ClienteCitas() {
  ...
  const [formData, setFormData] = useState({ profesionalId: '', servicioId: '', fecha: '', hora: '' });
    ...
    try {
      await apiRequest('/cliente/citas', {
        ...
        body: JSON.stringify({
          ...
          servicios: [Number(formData.servicioId)],
          fecha: formData.fecha,
          hora: formData.hora,
        }),
      });
      setFormData({ profesionalId: '', servicioId: '', fecha: '', hora: '' });
      setIsFormOpen(false);
      await loadData();
    } catch (err) {
        ...
        <div className="form-container">
          ...
          <form onSubmit={handleCrearCita}>
            ...
            <div className="form-group">
              ...
              <select value={formData.servicioId} onChange={(e) => setFormData({ ...formData, servicioId: e.target.value })} required>
